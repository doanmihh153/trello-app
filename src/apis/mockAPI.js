export const mockData = {
    board: {
        _id: 'board-id-01',
        title: 'Doan Quang Minh',
        description: 'Chua biet -- Nao thich thi viet!',
        type: 'public', // 'private'
        ...
        columns: [
                ...
                cards: [
                    {
                        ...
                        description: 'luoi roi -- tu tim hieu di :))',
                        cover: '/public/minhvakhay.jpg',
            ...
            },
            {
                ...
                cards: [
                    { _id: 'card-id-08', boardId: 'board-id-01', columnId: 'column-id-02', title: 'Title of card 08', description: null, cover: '/public/meme1.jpg', memberIds: [], comments: [], attachments: [] },
                    { _id: 'card-id-09', boardId: 'board-id-01', columnId: 'column-id-02', title: 'Title of card 09', description: null, cover: '/public/meme2.jpg', memberIds: [], comments: [], attachments: [] },
                    { _id: 'card-id-10', boardId: 'board-id-01', columnId: 'column-id-02', title: 'Title of card 10', description: null, cover: './minhvakhay.jpg', memberIds: [], comments: [], attachments: [] }
                ]
            },
            {
                _id: 'column-id-03',
                ...
                cards: [
                    { _id: 'card-id-11', boardId: 'board-id-01', columnId: 'column-id-03', title: 'Title of card 11', description: null, cover: '/public/meme1.jpg', memberIds: [], comments: [], attachments: [] },
                ...
                cards: [
                    {
                        ...
                        title: 'Title of card 14', description: null, cover: null, memberIds: [], comments: [], attachments: [],
